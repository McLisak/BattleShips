...
public class Player {
    ...
    private boolean[][] hitormiss = new boolean[14][22];
    private boolean chit = false;//checks if computer hit ship or not		
    private JButton[][] bboard = new JButton[14][22];
    //gbutton=new JButton [10][10];
    private int[][] mhs = new int[14][22];//used by computer to track miss(0)
    ...
    private String[][] whatship = new String[14][22];//stores name of ships or " "
    ...
    public Player(String name) {
        ...
        hits = 0;
        if ((user.equals("Computer")) || (user.equals("CPU1")) || (user.equals("CPU2"))
                || (Battleship.isAutoSet() && (user.equals("CPU1")) || (user.equals("CPU2"))) || (Battleship.isLocal())) {
            for (i = 0; i < 14; i++) {
                for (j = 0; j < 22; j++) {
                    ...
                    if (j <= 12) {
                        ...
                        this.bboard[i][j].setBackground(Color.yellow);
                    }
                    hitormiss[i][j] = false;
                    this.whatship[i][j] = " ";
                }
    ...
    public void humanAttack(ActionEvent v) {
        if (this.getMove()) {
            ...
            if (Battleship.getPlayers(Battleship.getEnemy()).getShipsLeft() != 0) {
                ...
                Battleship.flipYou();
            } else if (Battleship.getPlayers(Battleship.getEnemy()).getUser().equals("Computer"))//change once
            //menu options work
            {
    ...
    public void compattack() {
        ...
        if (Battleship.getPlayers(Battleship.getEnemy()).getShipsLeft() > 0) {
            ...
            Battleship.getPlayers(Battleship.getEnemy()).getTimer().start();
            Battleship.flipYou();
        } else if (this.getUser().equals("Computer")) {
