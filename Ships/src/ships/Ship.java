...
public class Ship {
        ...
        switch (this.dir) {
            case 0: {
                if ((this.length + this.y1) > 22) {
                    ...
                    JOptionPane.showMessageDialog(null, "A "
                            + this.name + " can't be placed in a "
                            + Battleship.getCletters(this.x1 + 1) + Battleship.getCnumbers(this.y1 + 1) + ", because it's a land",
                            "Invalid Placement", JOptionPane.ERROR_MESSAGE);
                    this.invalid = true;
                } else {
                    j = 0;
    ...
    public Ship compinput(int u, int n) {
        ...
        do {
            ...
            switch (dir) {
                case 0: {
                    if (((boat.getLength() + y) > 22) || (x == 0) || (y == 0)) {
                ...
                break;
                case 1: {
                    if (((x + boat.getLength()) > 14) || (x == 0) || (y == 0)) {
                        boat.setInvalid(true);
                    } else {
                        j = 0;
